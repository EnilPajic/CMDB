<!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        <script src="<?php echo e(asset('js/angular-recaptcha.min.js')); ?>"></script>
        <script src="<?php echo e(asset('js/app.js')); ?>"></script>
        <!-- Bootstrap core CSS -->
        <link href="<?php echo e(asset('css/bootstrap.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/signinImage.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/signin.css')); ?>" rel="stylesheet">
        <?php /*<link href="/public/css/bootstrap.min.css" rel="stylesheet">*/ ?>
        <?php /*<link href="/public/css" rel="stylesheet">*/ ?>
